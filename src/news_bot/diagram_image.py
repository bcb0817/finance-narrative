...
if __name__ == "__main__":
    samples = {
        "flow": {
            ...
            "hashtags": ["#米国株", "#金利"], "handle": "@finance_example",
        },
        "compare": {
            ...
            "right": {"title": "弱気シナリオ", "points": [
                ...
                "高いバリュエーションに割高感",
                "在庫調整・競合の台頭リスク"]},
            "hashtags": ["#エヌビディア", "#米国株"], "handle": "@finance_example",
        },
        "stat": {
            "type": "stat", "tag": "決算速報",
            ...
            "hashtags": ["#決算", "#エヌビディア"], "handle": "@finance_example",
        },
        "timeline": {
            ...
            "hashtags": ["#経済指標", "#米国株"], "handle": "@finance_example",
        },
        ...
        "chain": {  # flow系
            ...
            "hashtags": ["#為替", "#米国株"], "handle": "@finance_example",
        },
        "bull_bear": {  # compare系
            ...
            "right": {"title": "弱気材料", "points": [
                ...
                "円高反転による業績下振れ懸念",
                "海外景気の減速リスク"]},
            "hashtags": ["#日本株", "#日経平均"], "handle": "@finance_example",
        },
        "macro_indicator": {  # stat系
            ...
            "hashtags": ["#雇用統計", "#米国株"], "handle": "@finance_example",
        },
        "market_snapshot": {  # stat系
            ...
            "hashtags": ["#マーケット", "#為替"], "handle": "@finance_example",
        },
        "calendar": {  # timeline系
        ...
        "takeaway": {  # flow系
            ...
            "hashtags": ["#米国株", "#相場メモ"], "handle": "@finance_example",
        },
    }
